...
Usage
-----
Define your CXGroupBox member in your CDialog class, and CImageList with icons:
	CXGroupBox m_grpBox1, m_grpBox2, m_grpBox3, m_grpBox4;
	CImageList m_imgList;

in cpp:
-------
	CAppWithBrowse* pApp = (CAppWithBrowse*)AfxGetApp();
	m_imgList.Create(24, 24, ILC_COLOR8 | ILC_MASK, 0, 5);
	m_imgList.Add(pApp->LoadIcon(IDI_ICON1));
	m_imgList.Add(pApp->LoadIcon(IDI_ICON2));
	m_imgList.Add(pApp->LoadIcon(IDI_ICON3));
	m_imgList.Add(pApp->LoadIcon(IDI_ICON4));

	m_grpBox1.SubclassDlgItem(IDC_GROUPBOX1_IN_DIALOG_RESOPURCE, this);
	m_grpBox2.SubclassDlgItem(IDC_GROUPBOX2_IN_DIALOG_RESOPURCE, this);
	m_grpBox3.SubclassDlgItem(IDC_GROUPBOX3_IN_DIALOG_RESOPURCE, this);
	m_grpBox4.SubclassDlgItem(IDC_GROUPBOX4_IN_DIALOG_RESOPURCE, this);

	m_grpBox1.SetImageList(&m_imgList, 0, FALSE);
	m_grpBox2.SetImageList(&m_imgList, 1, FALSE);
	m_grpBox3.SetImageList(&m_imgList, 2, FALSE);
	m_grpBox4.SetImageList(&m_imgList, 3, FALSE);
...
-------------------
	...
	UINT fontColor = RGB(80,0,0);

 	m_grpBox1
 		.SetTextColor(fontColor, FALSE)
 		.SetFont(&lf);
